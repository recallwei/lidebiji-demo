...
const serviceData = [
  ...
  },
  {
    title: '任务管理',
    content:
      '将复杂工作拆分为细分任务，便于创作者快速理解、快速启动，便捷高效的进行任务管理',
  ...
  },
  {
    title: '素材管理',
    content:
      '平台提供素材存储管理功能，有效解决素材乱存、乱用、乱放等问题，帮助企业构建内容池',
...
const getPath = (name) => `/pages/operate/sponsor/${name}.png`
...
const targetData = [
  {
    ...
    totalNum: '803w+',
    searchNum: '212%',
    path: '/pages/operate/target/oiu.png'
  },
  {
    title: '台铃',
    tags: ['美好出行', '节能环保', '新能源'],
    ...
    totalNum: '472w+',
    searchNum: '64%',
    path: '/pages/operate/target/tai-ling.png'
  },
  {
    title: 'qborn',
    tags: ['男士护肤', '美妆个护', '他经济'],
    ...
    totalNum: '1278w++',
    searchNum: '139%',
    path: '/pages/operate/target/qborn.png'
  },
  {
    title: 'My First Book',
    tags: ['智力启蒙', '家庭早教', '早期教育'],
    ...
    totalNum: '563w+',
    searchNum: '139%',
    path: '/pages/operate/target/my-first-book.png'
  },
  {
    title: '小仙炖',
    tags: ['滋补养生', '创新鲜炖', '新鲜营养'],
    ...
    totalNum: '2630w+',
    searchNum: '420%',
    path: '/pages/operate/target/xiao-xian-dun.png'
  },
  {
    title: '乐蜗家纺',
    tags: ['时尚床品', '幸福生活', '自然健康'],
    ...
    totalNum: '193w+',
    searchNum: '64%',
    path: '/pages/operate/target/le-wo-jia-fang.png'
  },
  {
    title: '美赞臣',
    tags: ['母婴健康', '科研配方', '科学营养'],
    ...
    totalNum: '6457w+',
    searchNum: '445%',
    path: '/pages/operate/target/mei-zan-chen.png'
  },
  {
    title: '贝氪',
    tags: ['健康智能', '智慧睡眠', '智能办公'],
    ...
    totalNum: '358w+',
    searchNum: '41%',
    path: '/pages/operate/target/bei-ke.png'
  },
  {
    title: 'Five Doctors',
    tags: ['内服健康', '胶原蛋白', '科学抗老'],
    ...
    totalNum: '412w+',
    searchNum: '65%',
    path: '/pages/operate/target/five-doctors.png'
  }
]
