const bannerData = {
  title: '媒体投放',
  description:
    '新闻媒体发稿+自媒体推广 全网覆盖 一站式发布 多账号让您的内容引爆全网'
}
...
const serviceData = [
  ...
  },
  {
    title: '自媒体渠道',
    content:
      '自媒体，自媒体全平台覆盖，让内容铺遍全网，形成内容矩阵，助力企业提升品牌效益',
    path: '/pages/media/service/self-media.png'
  },
  {
    title: '价格透明',
    content:
      '品牌可以直接查看媒体/自媒体报价，选择心仪媒体资源，无复杂谈价环节',
...
const salesData = [
  {
    ...
    description:
      '通过官媒网站、权威媒体发布品牌内容，更易打造品牌专业形象、提升公信力'
  },
  {
    title: '精准投放',
    ...
    description:
      '企业可根据行业属性、产品受众精准选择媒体/自媒体类型，直接聚焦潜在用户群体'
  },
  {
    title: '成本更低',
    ...
    description:
      '一篇软文经撰写发布后，无后续的费用，而其他广告形式按日或周期付费，成本高昂'
  },
  {
    title: '全面覆盖',
    ...
    description:
      '内容可以从品宣、使用场景、用户痛点、差异化优势等多种角度出发，全面覆盖宣传重点'
  },
  {
    title: '持续影响',
    ...
    description:
      '软文发布后可以长期保留，持续产生影响力，若是被搜索引擎收录，还可以提升SEO'
  },
  {
    title: '操作灵活',
    ...
    description:
      '传统广告的效果通常受限于推荐量、推荐时段等问题，而软文从定题到发布则便于灵活调整'
  }
]
